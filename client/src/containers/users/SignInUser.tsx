...
interface IProps {
  ...
  ) => Promise<ApolloQueryResult<SignInMutation>>;
  currentUser: User;
...
class SignInUser extends React.Component<IProps, {}> {
  ...
  constructor(props: IProps) {
    ...
    this.redirectIfUserIsAuthenticated = this.redirectIfUserIsAuthenticated.bind(
      this,
    );
  }
...
const withSignIn = graphql<
  SignInMutation,
  SignInMutationVariables & MutationStateProps
>(SIGN_IN, {
